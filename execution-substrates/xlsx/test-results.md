...
| python | prediction_predicates | Has Syntax & Requires Parsing  | Has Syntax & Requires Parsing  |
| running-calculator-app | prediction_predicates | No Syntax & Requires Parsing & | No Syntax & Requires Parsing & |
| sign-language | prediction_predicates | Has Syntax & Requires Parsing  | Has Syntax & Requires Parsing  |
| ... | ... | (3 more) | ... |
