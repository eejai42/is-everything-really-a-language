...
str_31_len:
    ...
    .bss
    .globl _result_buf_eval_prediction_fail
    .p2align 3
_result_buf_eval_prediction_fail:
    .space 1024
    .globl _result_buf_eval_question
    .p2align 3
_result_buf_eval_question:
    .space 1024
    .globl _result_buf_eval_prediction_predicates
    .p2align 3
_result_buf_eval_prediction_predicates:
    .space 1024
...
_eval_question:
    ...
    ldr x0, [sp, #16]
    ldr x1, [sp, #24]
    adrp x22, _result_buf_eval_question@PAGE
    add x22, x22, _result_buf_eval_question@PAGEOFF
    ldr x4, [sp, #40]
    ldr x3, [sp, #32]
    mov x2, x1
    mov x1, x0
    ...
    .globl _eval_predicted_answer
    .p2align 2
_eval_predicted_answer:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    stp x19, x20, [sp, #-16]!
    stp x21, x22, [sp, #-16]!
...
and_end_2:
    ...
    .globl _eval_prediction_predicates
    .p2align 2
_eval_prediction_predicates:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    stp x19, x20, [sp, #-16]!
    stp x21, x22, [sp, #-16]!
...
if_end_18:
    ...
    ldr x0, [sp, #16]
    ldr x1, [sp, #24]
    adrp x22, _result_buf_eval_prediction_predicates@PAGE
    add x22, x22, _result_buf_eval_prediction_predicates@PAGEOFF
    ldr x4, [sp, #40]
    ldr x3, [sp, #32]
    mov x2, x1
    mov x1, x0
    ...
    .globl _eval_prediction_fail
    .p2align 2
_eval_prediction_fail:
    stp x29, x30, [sp, #-16]!
    mov x29, sp
    stp x19, x20, [sp, #-16]!
    stp x21, x22, [sp, #-16]!
...
if_end_24:
    ...
    ldr x0, [sp, #16]
    ldr x1, [sp, #24]
    adrp x22, _result_buf_eval_prediction_fail@PAGE
    add x22, x22, _result_buf_eval_prediction_fail@PAGEOFF
    ldr x4, [sp, #40]
    ldr x3, [sp, #32]
    mov x2, x1
    mov x1, x0
