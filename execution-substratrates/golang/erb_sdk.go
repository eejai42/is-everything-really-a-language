...
func (tc *LanguageCandidate) CalcPredictionPredicates() string {
	return func() string { if boolVal(tc.HasSyntax) { return "Has Syntax" }; return "No Syntax" }() + ", " + func() string { if boolVal(tc.RequiresParsing) { return "Requires Parsing" }; return "No Parsing Needed" }() + ", " + func() string { if boolVal(tc.IsDescriptionOf) { return "Describes the thing" }; return "Is the Thing" }() + ", " + func() string { if boolVal(tc.HasLinearDecodingPressure) { return "Has Linear Decoding Pressure" }; return "No Decoding Pressure" }() + ", " + func() string { if boolVal(tc.ResolvesToAnAST) { return "Resolves to AST" }; return "No AST" }() + ", " + func() string { if boolVal(tc.IsStableOntologyReference) { return "Is Stable Ontology" }; return "Not 'Ontology'" }() + ", " + func() string { if boolVal(tc.CanBeHeld) { return "Can Be Held" }; return "Can't Be Held" }() + " And " + func() string { if boolVal(tc.HasIdentity) { return "Has Identity" }; return "Has no Identity" }()
}
...
func (tc *LanguageCandidate) ComputeAll() *LanguageCandidate {
	...
	predictionPredicates := func() string { if boolVal(tc.HasSyntax) { return "Has Syntax" }; return "No Syntax" }() + ", " + func() string { if boolVal(tc.RequiresParsing) { return "Requires Parsing" }; return "No Parsing Needed" }() + ", " + func() string { if isDescriptionOf { return "Describes the thing" }; return "Is the Thing" }() + ", " + func() string { if boolVal(tc.HasLinearDecodingPressure) { return "Has Linear Decoding Pressure" }; return "No Decoding Pressure" }() + ", " + func() string { if boolVal(tc.ResolvesToAnAST) { return "Resolves to AST" }; return "No AST" }() + ", " + func() string { if boolVal(tc.IsStableOntologyReference) { return "Is Stable Ontology" }; return "Not 'Ontology'" }() + ", " + func() string { if boolVal(tc.CanBeHeld) { return "Can Be Held" }; return "Can't Be Held" }() + " And " + func() string { if boolVal(tc.HasIdentity) { return "Has Identity" }; return "Has no Identity" }()
